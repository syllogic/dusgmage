...
class Syllogic_CustomProductImport_Adminhtml_Customproductimportsubmenu2Controller extends Mage_Adminhtml_Controller_Action
{
	public function indexAction()
    {
       $this->loadLayout();
       $this->_title($this->__("Create Configurable Products with new Simple Products"));
        ...
        // checks the simple skus and simple attributes are equal
       		for($i=0;$i < count($get_all_simples_skus);$i++) {
       			  $item = array("store"=>"admin","type"=>"simple","sku"=>$get_all_simples_skus[$i],
   	                   ...
   	                   ,"websites"=>$cell[$websites_cell_no],
            ...
            $skipped = "yes";
       		$message.="<li>".$cell[$sku_cell_no] ."is row skipped due to simple skus and simple attributes are not equal values</li>";
        endif;
    /* =========================Create Simple products with required attributes ==================================*/
