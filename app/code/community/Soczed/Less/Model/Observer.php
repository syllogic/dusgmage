...
class Soczed_Less_Model_Observer
{
    ...
    public function beforeLayoutRender($observer)
    {
        ...
        if (($head = $layout->getBlock('head'))
            ...
            "footer_second_background" => Mage::getStoreConfig('themeoptions_theming/theme_footer/footer_second_background', $storeId),
            "footer_second_text_color" => Mage::getStoreConfig('themeoptions_theming/theme_footer/footer_second_text_color', $storeId),
            "footer_second_link_color" => Mage::getStoreConfig('themeoptions_theming/theme_footer/footer_second_link_color', $storeId),
            "footer_second_link_hover_color" => Mage::getStoreConfig('themeoptions_theming/theme_footer/footer_second_link_hover_color', $storeId),
            ...
            "footer_second_heading_color" => Mage::getStoreConfig('themeoptions_theming/theme_footer/footer_second_heading_color', $storeId),
