...
class TestLogger
{
    ...
    {
       //0Mage::getSingleton('adminhtml/session')->addSuccess("$type:$data\n") ;
    }
}
class Syllogic_CustomProductImport_Adminhtml_CustomproductupdateattributesController extends Mage_Adminhtml_Controller_Action
{
            ...
            if(isset($_FILES['csv_import']['name']) && $_FILES['csv_import']['name'] != '')
				{
    				...
    				{       
        				...
        				$fname = "attributes.csv"; //file name                        
        				...
        				$filename = Mage::getBaseDir().DS.'magmi/integration/samples/uploads/update'.DS."attributes.csv";
...
if($rows != 1) // Skipping the headers row
{
   ...
   /* =========================Bulk Update of Stock ============================*/
            		...
            		// $item = array("sku"=>$cell[$sku_cell_no],"sizechart" => $cell[$sizechart_cell_no]);
                ...
                $dp->ingest($item);
                $message.="<li>".$cell[$sku_cell_no] ." attributes are successfully updated to ".$cell[$sizechart_cell_no]."</li>";
